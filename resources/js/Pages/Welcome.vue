            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="flex items-center justify-between py-4 px-6">
                    ...
                    <Link href="/" class="flex-shrink-0">
                        <ApplicationLogo
                            class="h-14 w-14 fill-current text-gray-500"
                        />
                    </Link>

                    <!-- 검색 바 (가운데 정렬 + flex-grow) -->
                    <div class="flex-1 mx-4">
                        <div class="input-group input-group-sm w-full">
                            ...
                            />
                            <span
                                class="input-group-text border-0 p-2"
                                id="search-addon"
                            >
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#10B981]/10 sm:size-16"
                                    >
                                        <svg
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            PageSsence helps you discover the
                                            perfect book tailored to your taste.
                                            Whether you're an avid reader or
                                            just starting your literary journey,
                                            our platform guides you to books
                                            that match your interests, ensuring
                                ...
                                <svg
                                    class="size-6 shrink-0 stroke-[#000000]"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    PageSsence provides insightful reviews to
                                    help you choose your next great read.
                                    Whether you seek in-depth analysis or quick
                                    recommendations, our community-driven
                                    reviews offer honest opinions and thoughtful
                                    perspectives, guiding you toward books that
                                    truly resonate with you.
                                </p>
                            </div>

                            <svg
                                class="size-6 shrink-0 self-center stroke-[#000000]"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                        ...
                        >
                                ...
                                >
                                    ...
                                    >
                                        <g
                                            ...
                                            transform="translate(-259.000000, -257.000000)"
                                            fill="#000000"
                                        >
                                            <path
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    See what others think about your favorite
                                    books on PageSsence. Engage with a community
                                    of readers through comments, share your
                                    thoughts, and explore diverse perspectives,
                                    making your reading experience even more
                                    enriching.
                                </p>
                            </div>
